        ...
        <div className="flex justify-between items-center py-4">
          ...
          <motion.div
            ...
            <div className="relative">
              <div className="w-12 h-8 bg-gradient-to-r from-purple-500 to-pink-500 rounded-sm transform rotate-12 shadow-md">
              ...
              <div className="absolute -top-0.5 -right-0.5 w-2 h-2 bg-pink-400 rounded-full"></div>
              <div className="absolute -bottom-0.5 -left-0.5 w-1.5 h-1.5 bg-purple-400 rounded-full"></div>
            </div>
            ...
            <div className="flex flex-col">
              ...
              <div className="flex items-center space-x-2">
                <div className="w-6 h-px bg-gradient-to-r from-purple-400 to-pink-400"></div>
                <span className="text-xs font-medium text-gray-600 dark:text-gray-300 tracking-wider">
                  PERFUMES
                </span>
                <div className="w-6 h-px bg-gradient-to-r from-pink-400 to-purple-400"></div>
              </div>
            </div>
          </motion.div>
          ...
          <div className="py-4 space-y-2">
            {navItems.map((item) => (
              <motion.a
                key={item.name}
                href={item.href}
                className="block py-2 text-gray-700 dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-400 font-medium transition-colors duration-300"
                whileHover={{ x: 10 }}
